...
@for($i=1;$i<=2;$i++) <div class="row mb-5 recibos">
    <div class="col border rounded">
        ...
        <div class="row pt-2">
            <div class="col border rounded">
                Referente a: <b>Pagamento via Transferencia de {{$entry->valor_pagamento}} sacas de Soja, no Armazém Agrobom (Bom Jesus), referente a serviço prestado de colheita de Soja, Safra 22/23. <b>(Produto depositado em nome de WEIDER EURIPEDES PEREIRA, sob o CPF.: 829.870.921-72)</b> </b>
            </div>
        </div>
